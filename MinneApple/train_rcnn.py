...
def get_model_instance_segmentation(num_classes, model_type):
    if model_type == "frcnn":
        return get_frcnn_model_instance(num_classes)
    elif model_type == "maskrcnn":
        return get_maskrcnn_model_instance(num_classes)
    else:
...
def main(args):
    ...
    dataset = torch.utils.data.Subset(dataset, list(range(20)))
    dataset_test = torch.utils.data.Subset(dataset_test, list(range(10)))
